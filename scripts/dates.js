...
const formattedDate = `${lastDateModified.getFullYear()} / 0${lastDateModified.getMonth() + 1} / 0${lastDateModified.getDate()} - ${lastDateModified.getHours()}:${lastDateModified.getHours()}`;
